// LEGACY: Старые страницы сайта (CatalogPage, GamePage, TeamsPage, EditorPage)
// Вынесены в legacy для Phase 1: Cleanup (M0) - FP7 v2
// Эти компоненты использовали react-router и противоречат shell-only контракту
